...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (paymentMethodSelect && cardContainer && cardInput) {
        paymentMethodSelect.addEventListener('change', function() {
            // Show for both Credit Card and Debit Card
    ...
    document.querySelectorAll('#payable-items tbody tr').forEach(attachListeners);
});

function addItem() {
    const tableBody = document.getElementById('payable-items').querySelector('tbody');
...
function updateTotals() {
    ...
    document.querySelectorAll('#payable-items tbody tr').forEach(row => {
