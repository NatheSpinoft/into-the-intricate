...
<div class="container">
    ...
    <div class="main">
        <form class="invoice-form" method="POST" action="add_payable.php">
            <h1>Record Bill/Expense</h1>
            <div class="invoice-header">
                <label>Date:
                    <input type="date" name="bill_date" required>
                </label>
                <label>Vendor/Supplier:
                    <input type="text" name="vendor" placeholder="Company Name" required>
                </label>
            </div>

            <h3>Items</h3>
            <table class="invoice-items" id="payable-items">
                <thead>
                    <tr>
                        <th>Description</th>
                        <th>Qty</th>
        ...
        <script src="../assets/js/payables.js"></script>
    </div>
</div>
