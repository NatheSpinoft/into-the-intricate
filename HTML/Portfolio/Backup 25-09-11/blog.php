    ...
    <div class="container">
        ...
        <div class="column">
            <div class="weather-column">
                <h3>Weather in <?= htmlspecialchars($weather['city']); ?></h3>
                <p><strong>Temperature:</strong> 
                    <?= is_numeric($weather['tempC']) ? round($weather['tempC']) . "°C / " . round($weather['tempF']) . "°F" : "N/A"; ?>
                </p>
                <p><strong>Condition:</strong> 
                    <?= !empty($weather['condition']) ? ucfirst($weather['condition']) : "N/A"; ?>
                </p>
                <p><strong>Humidity:</strong> 
                    <?= is_numeric($weather['humidity']) ? $weather['humidity'] . "%" : "N/A"; ?>
                </p>
                <p><strong>Wind Speed:</strong> 
                    <?= is_numeric($weather['windSpeed']) ? $weather['windSpeed'] . " m/s" : "N/A"; ?>
                </p>
            </div>
        </div>
